    ...
    return (
        <div className={`${styles.container} ${cartView ? styles.active : null}`}>
                                    ...
                                    <div>
                                        <div>
                                            ...
                                            <p className={styles.size}>
                                                Price:{" "}
                                                {formatPrices(cart as unknown as Cart, i.variant)}
                                            </p>
                                        </div>
                                        <div>
            ...
            <div className={styles.subtotal}>
                ...
                <span>
          {(cart as unknown as Cart).region ? formatPrice((cart as unknown as Cart).subtotal || 0, currencyCode) : 0}
        </span>
            </div>
