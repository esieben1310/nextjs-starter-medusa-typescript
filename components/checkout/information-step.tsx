...
const InformationStep: FunctionComponent<Props> = ({isProcessing, savedValues, handleSubmit}) => {
            ...
            <Formik
                initialValues={{
                    ...
                    country_code: savedValues.country_code ||
                        (cart as unknown as Cart)?.region?.countries?.[0].iso_2 ||
                        "",
                    ...
                    <Form className={styles.styledform}>
                        {isProcessing ? (
                            ...
                            <>
                                ...
                                <SelectField
                                    id="country_code"
                                    options={(cart as unknown as Cart).region?.countries}
